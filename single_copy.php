<?php
if(in_category(32)) {
    include 'templates/page-portfolio.php';
} else { ?>

    <?php get_header(); ?>

    <section class="news_section">
        <div class="container-flusingle.phpid">
            <div class="row">
                        ...
                        <?php if (have_posts()) : ?>
                            <?php while (have_posts()) : the_post(); ?>
                                <article class="current_news">
                                    ...
                                    <div class="container wow fadeIn"><img class="news_image"
                                                                           src="<?php bloginfo('template_url'); ?>/img/img-10.jpg"
                ...
                <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                    ...
                    <div class="recent_posts block">
                        ...
                        <div class="post">
                            <img class="recent_post_image" src="<?php bloginfo('template_url'); ?>/img/img-10.jpg"
                                 alt="Aliquam erat volutpat"/>
                        ...
                        <div class="post">
                            <img class="recent_post_image" src="<?php bloginfo('template_url'); ?>/img/img-11.jpg"
                                 alt="Mauris posuere"/>
                            <span class="glyphicon glyphicon-calendar"></span>
                        ...
                        <div class="post">
                            <img class="recent_post_image" src="<?php bloginfo('template_url'); ?>/img/img-12.jpg"
                                 alt="Mauris posuere"/>
                            <span class="glyphicon glyphicon-calendar"></span>
