...
<div class="container-fluid">
    ...
    <div id="towards" class="row">
        <div class="container">
            ...
            <div class="col-lg-6 img-couple">
                ...
                $urlArray=wp_get_attachment_image_src($attachments[0]->ID, 'full',true);
                ?>
                    <div
    ...
    <div id="about" class="row">
        <div class="container">
            <h2><?php
                ...
                ?></h2>
            <div class="row">
                <?php $query = new WP_Query(array('post_type' => 'aboutus',
                    'post_status' => 'publish'));
                    if($query->have_posts()):
                while($query->have_posts()): $query->the_post();
                ?>
    ...
    <div id="schedule" data-parallax="scroll" data-image-src="<?php bloginfo('template_url'); ?>/img/cb.jpg">
        <div class="container">
            <section>
                <?php $query = new WP_Query(array('post_type' => 'schedule',
                    'post_status' => 'publish',
                    'posts_per_page' => '1'));
                if ($query->have_posts()):
                    while ($query->have_posts()):$query->the_post();
